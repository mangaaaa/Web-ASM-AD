...
<html lang="en">
    ...
    <body>
        ...
        <div id="add-search">
            <div class="add">
                <button id="addTrainee" class="button"><span>Add new trainer </span></button>
            </div>
            <div class="search">
                <form>
        ...
        <div id="add-new">
            <form action="" class="was-validated">
                ...
                <c:if test="${empty requestScope['listTopic']}">
                    <jsp:forward page = "/TrainerModel?ac=viewTopic" />
                </c:if>
                <c:forEach items="${listTopic}" var = "x" >
                    <input type="checkbox" id="exampleCheck1">
                    <label for="exampleCheck1">${x.getTopicName()}</label>
                </c:forEach>
            </form>
        </div>
        <br>
        <br>
        <input type="button" class="btn btn-primary" value="add" style="margin-left: 40%" >
    </form>
</div>
</body>
</html>